...
1) Перейти по ссылке на задание в GitHub Clasroom, будет создан ваш личный репозиторий.
2) Выполнить задание. Все комиты отправить в master.
3) Отправить ссылку на выполненное задание в дискорд канал #ready-for-review
4) Переходить к следующему заданию
5) Если к предыдущему заданию пришли какие-то замечания то исправить их и снова опубликовать ссылку в #ready-for-review
