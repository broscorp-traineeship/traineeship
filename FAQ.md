...
- Никаких сроков по выполнению заданий нет, чем быстрее справишься с заданиями - тем быстрее мы сможем перевести на воторой этап стажировки.
...
3.	**После стажировки, на какой проект меня распределят?**
- Каждый кандидат рассматривается отдельно, поэтому для каждого кандидата будет подобран определенный проект.
- 4.	**Что такое следующий этап стажировки?**
- На следующем этапе стажировки даются более сложные задания.
